...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYEMPLOYEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYEMPLOYEE actions', async () => {
      const expectedActions = [
        {
