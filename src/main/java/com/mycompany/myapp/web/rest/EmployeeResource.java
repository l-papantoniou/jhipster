...
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees(
        ...
        log.debug("REST request to get Employees by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countEmployees(EmployeeCriteria criteria) {
        log.debug("REST request to count Employees by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
