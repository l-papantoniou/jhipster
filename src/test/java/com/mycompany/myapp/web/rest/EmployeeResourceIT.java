...
class EmployeeResourceIT {
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getAfm()).isEqualTo(DEFAULT_AFM);
    }
    ...
    @Test
    @Transactional
    void getAllEmployeesByAfmIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where afm equals to DEFAULT_AFM
        defaultEmployeeShouldBeFound("afm.equals=" + DEFAULT_AFM);

        // Get all the employeeList where afm equals to UPDATED_AFM
        defaultEmployeeShouldNotBeFound("afm.equals=" + UPDATED_AFM);
    }

    @Test
    @Transactional
    void getAllEmployeesByAfmIsInShouldWork() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where afm in DEFAULT_AFM or UPDATED_AFM
        defaultEmployeeShouldBeFound("afm.in=" + DEFAULT_AFM + "," + UPDATED_AFM);

        // Get all the employeeList where afm equals to UPDATED_AFM
        defaultEmployeeShouldNotBeFound("afm.in=" + UPDATED_AFM);
    }

    @Test
    @Transactional
    void getAllEmployeesByAfmIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where afm is not null
        defaultEmployeeShouldBeFound("afm.specified=true");

        // Get all the employeeList where afm is null
        defaultEmployeeShouldNotBeFound("afm.specified=false");
    }

    @Test
    @Transactional
    void getAllEmployeesByAfmContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where afm contains DEFAULT_AFM
        defaultEmployeeShouldBeFound("afm.contains=" + DEFAULT_AFM);

        // Get all the employeeList where afm contains UPDATED_AFM
        defaultEmployeeShouldNotBeFound("afm.contains=" + UPDATED_AFM);
    }

    @Test
    @Transactional
    void getAllEmployeesByAfmNotContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where afm does not contain DEFAULT_AFM
        defaultEmployeeShouldNotBeFound("afm.doesNotContain=" + DEFAULT_AFM);

        // Get all the employeeList where afm does not contain UPDATED_AFM
        defaultEmployeeShouldBeFound("afm.doesNotContain=" + UPDATED_AFM);
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE).afm(UPDATED_AFM);
        ...
        assertThat(testEmployee.getAfm()).isEqualTo(UPDATED_AFM);
    }
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE).afm(UPDATED_AFM);
